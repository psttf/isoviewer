namespace Ps.Iso.Viewer
{
	partial class SaveIsoDialog
	{
		...
		private void InitializeComponent()
		{
			...
			// tbRecordNumbers
			// 
			this.tbRecordNumbers.Location = new System.Drawing.Point(104, 65);
			...
			this.rbSaveAllExceptSelected.Checked = true;
			this.rbSaveAllExceptSelected.Location = new System.Drawing.Point(6, 19);
			this.rbSaveAllExceptSelected.Name = "rbSaveAllExceptSelected";
			this.rbSaveAllExceptSelected.Size = new System.Drawing.Size(198, 17);
			this.rbSaveAllExceptSelected.TabIndex = 1;
			this.rbSaveAllExceptSelected.TabStop = true;
			this.rbSaveAllExceptSelected.Text = "все записи кроме перечисленных";
			this.rbSaveAllExceptSelected.UseVisualStyleBackColor = true;
			// 
			// rbSaveOnlySelected
			// 
			this.rbSaveOnlySelected.AutoSize = true;
			this.rbSaveOnlySelected.Location = new System.Drawing.Point(6, 42);
			this.rbSaveOnlySelected.Name = "rbSaveOnlySelected";
			this.rbSaveOnlySelected.Size = new System.Drawing.Size(181, 17);
			this.rbSaveOnlySelected.TabIndex = 0;
			this.rbSaveOnlySelected.Text = "только перечисленные записи";
			this.rbSaveOnlySelected.UseVisualStyleBackColor = true;
			// 
			// btCancel
			// 
			this.btCancel.Location = new System.Drawing.Point(351, 137);
			...
			// btSave
			// 
			this.btSave.Location = new System.Drawing.Point(270, 137);
